...
Shard completed/ to YYYY/MM/. Added walk_completed() helper to TaskAgent for transparent handling of both flat and month-sharded layouts. Updated complete_issue, find_issue_file, cmd_search, cmd_history, cmd_triage, and cmd_recover_history to use the new depth. Added one-time migration in ingest_issues that relocates flat completed/YYYY/ entries to completed/YYYY/MM/ based on created_at frontmatter, and runs _migrate_file_headers over the completed tree.

---
**Completed in commit:** `f038d42`
