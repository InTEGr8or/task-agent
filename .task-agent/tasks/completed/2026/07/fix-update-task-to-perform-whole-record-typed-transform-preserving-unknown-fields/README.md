...
Fixed update_issue to do read-modify-write via _merge_record helper that preserves frontmatter and edge-field prose the caller did not explicitly set. Also removed legacy **Blocked by:** parsing from update_issue and update_dependencies. Added 3 tests covering frontmatter preservation, edge-field preservation, and edge-field override.
