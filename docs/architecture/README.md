...
We use the **Frictionless Data** standard to describe the schema of `mission.usv`. This allows other tools to easily parse our USV format without hardcoded logic.
